...
function click_animation_bounce(element) {
    void element.offsetWidth;
    element.classList.add('animate__animated');
...
function click_animation_flash(element) {
    void element.offsetWidth;
    element.classList.add('animate__animated');
...
function click_animation_swing(element) {
    void element.offsetWidth;
    element.classList.add('animate__animated');
...
function click_animation_tada(element) {
    void element.offsetWidth;
    element.classList.add('animate__animated');
...
function click_animation_heartBeat(element) {
    void element.offsetWidth;
    element.classList.add('animate__animated');
